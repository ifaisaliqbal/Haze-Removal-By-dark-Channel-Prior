function [J,reg_mean,reg_list] = Region_Growing(I,x,y,reg_maxdist)
...
while(pixdist<reg_maxdist&&reg_size<numel(I))
    ...
    reg_list(reg_count,:)= neg_list(index,1:2); 
    J(x,y)=2; reg_size=reg_size+1;
   if(pixdist<reg_maxdist&&reg_size<numel(I)) reg_list(reg_count+1,:)=0;     reg_count = reg_count + 1; end
